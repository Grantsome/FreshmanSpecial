...
public class TransformImageView extends PhotoView {
    ...
    private void initTransformImageView() {
        mPaint = new Paint();
    ...
    public void setOnTransformListener(TransformImageView.onTransformListener onTransformListener) {
    ...
    public static int getStatusBarHeight(Context context) {
        ...
        int x = 0;
        int statusBarHeight = context.getResources().getDimensionPixelSize(R.dimen.action_bar_height);
        try {
